...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        # the output of the network is the *normalized change* in state, i.e. normalized(s_t+1 - s_t).
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        data_statistics_pt = {i: ptu.from_numpy(j) for i, j in data_statistics.items()}
        prediction, _ = self(obs, acs, **data_statistics_pt)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        _, delta_pred_normalized = self(obs, acs, **data_statistics_pt)
